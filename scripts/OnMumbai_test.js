...
const main = async () => {
  ...
  const pro_ponContract = new ethers.Contract(
   ...
   //console.log('pro_ponContract',pro_ponContract)
  const  RFP = await pro_ponContract.getRFPbyIndex(34);
  //const  company = await pro_ponContract.getCompany('0xE9B1436262593fA862911eDD0C78017B77D131ab')
  //console.log('company:', company)
  console.log('RFP:', RFP[0])
