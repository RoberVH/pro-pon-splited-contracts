...
const main = async () => {
  ...
  const CREATE_COMPANY_PRICE=await pro_ponContract.CREATE_COMPANY_PRICE()
  const CREATE_OPEN_RFP_PRICE=await pro_ponContract.CREATE_OPEN_RFP_PRICE()
  const CREATE_INVITATION_RFP_PRICE=await pro_ponContract.CREATE_INVITATION_RFP_PRICE()
  const REGISTER_OPEN_RFP_PRICE=await pro_ponContract.REGISTER_OPEN_RFP_PRICE()

  console.log('CREATE_COMPANY_PRICE',ethers.utils.formatEther(CREATE_COMPANY_PRICE))
  console.log('CREATE_OPEN_RFP_PRICE',ethers.utils.formatEther(CREATE_OPEN_RFP_PRICE))
  console.log('CREATE_INVITATION_RFP_PRICE',ethers.utils.formatEther(CREATE_INVITATION_RFP_PRICE))
  console.log('REGISTER_OPEN_RFP_PRICE',ethers.utils.formatEther(REGISTER_OPEN_RFP_PRICE))
return
/*    let test_pro_pon1 = {
      "id": "CLI160511W1M",
      "name": "Clionautacion",
